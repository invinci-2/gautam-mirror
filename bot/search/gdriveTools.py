    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = "Gautam'S Mirror Search",
                                 author_name="Gautam'S Mirror",
                                 author_url='https://t.me/Gautams_mirror',
                ...
                for file in response:
                    ...
                    if x:
                        if add_title_msg == True:
                            msg = f'<h3>Sᴇᴀʀᴄʜ Rᴇsᴜʟᴛs Fᴏʀ : {fileName}</h3><br><b><a href="https://mirror.18gautam304.workers.dev"> Index Homepage </a></b> ||<b><a href="https://t.me/Gautam1834"> Owner </a></b><br><br>'
                            add_title_msg = False
